...
export function LoginForm({
  ...
  const googleOAuthUrl = "https:\/\/accounts.google.com\/o\/oauth2\/v2\/auth?client_id=631068069831-1utk3s0eeo2se9526mlisjemp134vm3d.apps.googleusercontent.com&redirect_uri=http:\/\/localhost:5173&response_type=token&scope=email";
